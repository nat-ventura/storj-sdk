...
docker exec -it storjsdk_mongos_1 /bin/bash -c "mongo localhost:27017/bridge --ssl --sslAllowInvalidCertificates --sslAllowInvalidHostnames --eval 'db.users.insert({ \"_id\" : \"billing@storj.io\", \"paymentProcessors\" : [ ], \"bytesDownloaded\" : { \"lastMonthBytes\" : 0, \"lastDayBytes\" : 0, \"lastHourBytes\" : 0 }, \"bytesUploaded\" : { \"lastMonthBytes\" : 0, \"lastDayBytes\" : 0, \"lastHourBytes\" : 0 }, \"isFreeTier\" : true, \"activated\" : true, \"resetter\" : null, \"deactivator\" : null, \"activator\" : null, \"created\" : ISODate(\"2017-01-31T18:18:42.523Z\"), \"pendingHashPass\" : null, \"__v\" : 0 })'" > /dev/null 2>&1
docker exec -it storjsdk_mongos_1 /bin/bash -c "mongo localhost:27017/bridge --ssl --sslAllowInvalidCertificates --sslAllowInvalidHostnames --eval 'db.publickeys.insert({ \"_id\" : \"02439658e54579d120b0fd24d323e413d028704f845b8f7ab5b11e91d6cd5dbb00\", \"user\" : \"billing@storj.io\", \"label\" : \"\"})'" > /dev/null 2>&1
